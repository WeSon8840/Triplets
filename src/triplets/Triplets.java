/*
 * The purpose is to use Giggity Code to create a program that 
   will generate random triplet poems.
 */
...
public class Triplets {
    ...
    public static void main(String[] args) {
        ...
        //get second random noun from the nouns array
        randomNum = (int) (Math.random() * nouns.size());
        ...
        //Display the poem
        System.out.println("when a" + noun + " " + verb1 + "a" + rhymingNoun1+ "\n"
                           + "And then the" + rhymingNoun2 + "\n"
                           + "Around the" + rhymingNoun1 + "\n");
        
        //Tere was a mouse
        //That likes to wear a blouse
        //Around the house.
